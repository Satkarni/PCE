...
/*! \fn void spi_init()
		...
		Initializes SPI, to be called before calling any display function
*/
void spi_init(){
...
/*! \fn void spiSendByte (char databyte)
		\brief Sends databyte over SPI
*/
...
//	DISPLAY_DIR |= (1<<LED9)|(1<<LED10)|(1<<LED11)|(1<<LED12);
...
void MAX7219_displayLED(uint16_t state)
{
    uint8_t digit1 = state;
    uint8_t digit2 = (state >> 4) & 0xF0;

	MAX7219_writeData(MAX7219_DIGIT1,digit1,CHIP3);
	MAX7219_writeData(MAX7219_DIGIT2,digit2,CHIP3);
}
