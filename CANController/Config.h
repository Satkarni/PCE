...
#define LOP_TRIP_DF			( 10 )	// kPa  (multiply BAR by 100, example->  0.8 bar = 80 kPa, 2 bar = 200 kPa)
#define WT_TRIP_DF			( 105 )	// deg C
#define RPM_TRIP_DF			( 2530 ) 
#define RPM_RUN_ON			( 500 )
#define FAULT_ENABLE_DF		(500)	// rpm
#define FAULT_DISABLE_DF	(300)	// rpm

#define LOP_TRIP_DELAY_DF			( 5 )	// sec
#define WT_TRIP_DELAY_DF			( 5 )	// sec
#define RPM_TRIP_DELAY_DF			( 2 )	// sec
#define COOLANT_LEVEL_TRIP_DELAY_DF ( 5 )   // sec
